# Using the Ruby language, have the function CorrectPath(str) read the str parameter being passed,
# which will represent the movements made in a 5x5 grid of cells starting from the top left position.
# The characters in the input string will be entirely composed of: r, l, u, d, ?. Each of the
# characters stand for the direction to take within the grid, for example: r = right, l = left, u =
# up, d = down. Your goal is to determine what characters the question marks should be in order for a path to be created to go from the top left of the grid all the way to the bottom right without
